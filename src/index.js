...
function joinInner(data, joinData, joinCondition, fields, table) {
...
function leftJoin(data, joinData, joinCondition, fields, table) {
    return data.flatMap(mainRow => {
...
async function SELECTQuery(query) {
    ...
    if (joinTable && joinCondition) {
        ...
        switch (joinType.toUpperCase()) {
            case 'INNER':
                data = joinInner(data, joinData, joinCondition, fields, table);
                break;
            case 'LEFT':
                data = leftJoin(data, joinData, joinCondition, fields, table);
                break;
            case 'RIGHT':
